...
linreg <- setRefClass("linreg", 
                         ...
                         methods = list(
                           ...
                           p1 <- ggplot2::qplot(x = y_hat,y = e_hat,main='Residual vs Fitted',ylab = 'Rediduals',xlab =titl)+ggplot2::geom_smooth(method = "lm")+ggplot2::theme(plot.background = ggplot2::element_rect(fill = "#00cfb5"), panel.grid.major = ggplot2::element_line(colour = "#17c7d2"), axis.text = ggplot2::element_text(colour = "#687f91"))
                           p2 <- ggplot2::qplot(x = y_hat,y = yax_2,main='Residual vs Fitted',ylab = expression(sqrt(abs(paste(Standardized,phantom(ph),residuals)))),xlab =titl)+ggplot2::geom_smooth(method = "lm")+ggplot2::theme(plot.background = ggplot2::element_rect(fill = "#00b9e7"), panel.grid.major = ggplot2::element_line(colour = "#17c7d2"), axis.text = ggplot2::element_text(colour = "#687f91"))
                           return(list(p1,p2))},
